...
app.get("/", async function(req, res){
 ...
 res.render("index", {"image2":parsedData.hits[1].largeImageURL});
 res.render("index", {"image3":parsedData.hits[2].largeImageURL});
 res.render("index", {"image4":parsedData.hits[3].largeImageURL});
